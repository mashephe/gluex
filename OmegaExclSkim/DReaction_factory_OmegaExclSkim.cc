// $Id$
//
//    File: DReaction_factory_OmegaExclSkim.cc
...
void DReaction_factory_OmegaExclSkim::PIDCuts(DReaction* locReaction)
{
...
// brun
//------------------
jerror_t DReaction_factory_OmegaExclSkim::brun(JEventLoop* locEventLoop, int32_t locRunNumber)
{
...
// init
//------------------
jerror_t DReaction_factory_OmegaExclSkim::evnt(JEventLoop* locEventLoop, uint64_t locEventNumber)
{
...
// fini
//------------------
jerror_t DReaction_factory_OmegaExclSkim::fini(void)
{
